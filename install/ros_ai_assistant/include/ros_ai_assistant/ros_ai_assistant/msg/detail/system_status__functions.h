...
#ifndef ROS_AI_ASSISTANT__MSG__DETAIL__SYSTEM_STATUS__FUNCTIONS_H_
#define ROS_AI_ASSISTANT__MSG__DETAIL__SYSTEM_STATUS__FUNCTIONS_H_
 ...
 * calls
 * ros_ai_assistant__msg__SystemStatus__init().
...
/**
 * It calls
 * ros_ai_assistant__msg__SystemStatus__fini()
 ...
 * ros_ai_assistant__msg__SystemStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * ros_ai_assistant__msg__SystemStatus__Sequence__fini()
 * on the array,
...
#endif  // ROS_AI_ASSISTANT__MSG__DETAIL__SYSTEM_STATUS__FUNCTIONS_H_
