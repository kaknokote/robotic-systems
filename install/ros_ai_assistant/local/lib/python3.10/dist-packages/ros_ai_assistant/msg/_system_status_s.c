...
bool ros_ai_assistant__msg__system_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_ai_assistant.msg._system_status.SystemStatus", full_classname_dest, 48) == 0);
  }
  ros_ai_assistant__msg__SystemStatus * ros_message = _ros_message;
  {  // header
...
PyObject * ros_ai_assistant__msg__system_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_ai_assistant.msg._system_status");
