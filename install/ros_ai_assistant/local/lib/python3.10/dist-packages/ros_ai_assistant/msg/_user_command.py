    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'ros_ai_assistant.msg.UserCommand')
            logger.debug(
...
class UserCommand(metaclass=Metaclass_UserCommand):
    ...
    def __init__(self, **kwargs):
        ...
        self.command_text = kwargs.get('command_text', str())
    ...
    def __eq__(self, other):
        ...
        if self.command_id != other.command_id:
            return False
        if self.command_text != other.command_text:
            return False
    ...
    def command_text(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'command_text' field must be of type 'str'"
