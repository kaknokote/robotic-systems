...
static const _ThreatAssessment_Request_type_support_symbol_names_t _ThreatAssessment_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_ai_assistant, srv, ThreatAssessment_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_ai_assistant, srv, ThreatAssessment_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros_ai_assistant, srv, ThreatAssessment_Request)() {
  return &::ros_ai_assistant::srv::rosidl_typesupport_c::ThreatAssessment_Request_message_type_support_handle;
}
...
static const _ThreatAssessment_Response_type_support_symbol_names_t _ThreatAssessment_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_ai_assistant, srv, ThreatAssessment_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_ai_assistant, srv, ThreatAssessment_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros_ai_assistant, srv, ThreatAssessment_Response)() {
  return &::ros_ai_assistant::srv::rosidl_typesupport_c::ThreatAssessment_Response_message_type_support_handle;
}
...
static const _ThreatAssessment_type_support_symbol_names_t _ThreatAssessment_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_ai_assistant, srv, ThreatAssessment)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_ai_assistant, srv, ThreatAssessment)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ros_ai_assistant, srv, ThreatAssessment)() {
  return &::ros_ai_assistant::srv::rosidl_typesupport_c::ThreatAssessment_service_type_support_handle;
}
