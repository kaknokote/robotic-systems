...
static const _OpenAIRequest_Request_type_support_symbol_names_t _OpenAIRequest_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_ai_assistant, srv, OpenAIRequest_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_ai_assistant, srv, OpenAIRequest_Request)),
  }
};
...
{
  return &::ros_ai_assistant::srv::rosidl_typesupport_cpp::OpenAIRequest_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros_ai_assistant, srv, OpenAIRequest_Request)() {
  return get_message_type_support_handle<ros_ai_assistant::srv::OpenAIRequest_Request>();
}
...
static const _OpenAIRequest_Response_type_support_symbol_names_t _OpenAIRequest_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_ai_assistant, srv, OpenAIRequest_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_ai_assistant, srv, OpenAIRequest_Response)),
  }
};
...
{
  return &::ros_ai_assistant::srv::rosidl_typesupport_cpp::OpenAIRequest_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros_ai_assistant, srv, OpenAIRequest_Response)() {
  return get_message_type_support_handle<ros_ai_assistant::srv::OpenAIRequest_Response>();
}
...
static const _OpenAIRequest_type_support_symbol_names_t _OpenAIRequest_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_ai_assistant, srv, OpenAIRequest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_ai_assistant, srv, OpenAIRequest)),
  }
};
...
{
  return &::ros_ai_assistant::srv::rosidl_typesupport_cpp::OpenAIRequest_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, ros_ai_assistant, srv, OpenAIRequest)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<ros_ai_assistant::srv::OpenAIRequest>();
}
