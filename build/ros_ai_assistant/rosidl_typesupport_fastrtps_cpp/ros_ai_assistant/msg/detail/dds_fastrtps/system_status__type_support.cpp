...
#include "ros_ai_assistant/msg/detail/system_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_ai_assistant::msg::SystemStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_ai_assistant::msg::SystemStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_ai_assistant::msg::SystemStatus *>(
    untyped_ros_message);
...
{
  return &ros_ai_assistant::msg::typesupport_fastrtps_cpp::_SystemStatus__handle;
}
