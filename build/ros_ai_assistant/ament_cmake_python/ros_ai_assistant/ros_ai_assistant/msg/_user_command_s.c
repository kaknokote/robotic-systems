...
bool ros_ai_assistant__msg__user_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_ai_assistant.msg._user_command.UserCommand", full_classname_dest, 46) == 0);
  }
  ros_ai_assistant__msg__UserCommand * ros_message = _ros_message;
  {  // header
  ...
  {  // command_text
    PyObject * field = PyObject_GetAttrString(_pymsg, "command_text");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->command_text, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // command_type
...
PyObject * ros_ai_assistant__msg__user_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_ai_assistant.msg._user_command");
  ...
  {  // command_text
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->command_text.data,
      strlen(ros_message->command_text.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "command_text", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
