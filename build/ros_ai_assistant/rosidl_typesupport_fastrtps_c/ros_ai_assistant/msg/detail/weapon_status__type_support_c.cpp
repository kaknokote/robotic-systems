...
#include "ros_ai_assistant/msg/detail/weapon_status__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // mode, status_message
#include "rosidl_runtime_c/string_functions.h"  // mode, status_message
...
using _WeaponStatus__ros_msg_type = ros_ai_assistant__msg__WeaponStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _WeaponStatus__ros_msg_type * ros_message = static_cast<const _WeaponStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _WeaponStatus__ros_msg_type * ros_message = static_cast<_WeaponStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_ros_ai_assistant__msg__WeaponStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _WeaponStatus__ros_msg_type * ros_message = static_cast<const _WeaponStatus__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _WeaponStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_ai_assistant__msg__WeaponStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_ai_assistant
size_t max_serialized_size_ros_ai_assistant__msg__WeaponStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_ai_assistant__msg__WeaponStatus;
    is_plain =
      (
...
static size_t _WeaponStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_ai_assistant__msg__WeaponStatus(
...
static message_type_support_callbacks_t __callbacks_WeaponStatus = {
...
static rosidl_message_type_support_t _WeaponStatus__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_WeaponStatus,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_ai_assistant, msg, WeaponStatus)() {
  return &_WeaponStatus__type_support;
}
